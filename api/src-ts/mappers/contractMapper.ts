...
export function mapContract(raw: Record<string, any>): ContractRow {
  return {
    ...
    custrecord_cryo_mx_zonacobranza: toStringOrNull(raw.custrecord_cryo_mx_zonacobranza),
    custrecord_cryo_mx_estatus_cobranza: toStringOrNull(raw.custrecord_cryo_mx_estatus_cobranza),
    custrecord_cryo_mx_clasificadormetal: toStringOrNull(raw.custrecord_cryo_mx_clasificadormetal),
    custrecord_cryo_mx_estatus_cliente: toStringOrNull(raw.custrecord_cryo_mx_estatus_cliente),
    custrecord_cryo_mx_franquiciaasociado: toStringOrNull(raw.custrecord_cryo_mx_franquiciaasociado),
    ...
    custrecord_cryo_ginecoloco: toStringOrNull(raw.custrecord_cryo_ginecoloco),
    custrecord_cryo_mx_referencia_sap: toStringOrNull(raw.custrecord_cryo_mx_referencia_sap),
