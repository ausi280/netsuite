...
const VALID_ENTITIES: SyncEntityName[] = ['customer', 'contract', 'familyMember', 'service', 'invoice', 'payment', 'employee', 'receivable', 'hospital', 'partida', 'serviceType', 'servicePackage', 'serialNumber', 'medico', 'medicoColombia', 'vendor', 'vendorTransaction', 'vendorBillPayment', 'otrosContrato', 'peServicio'];
